      ...
      <div className="center-div-container">
        ...
        <div className="sign-up-box">
          ...
          <form autoComplete="off" onSubmit={handleSubmit}>
            ...
            <input name="email" placeholder="E-mail Address" autoComplete="new-password" onChange={(e) => setEmail(e.target.value)} />

            <input name="password" type="password" placeholder="Password" autoComplete="new-password" onChange={(e) => setPassword(e.target.value)} />
